...
const Banner = () => {
  ...
  return (
    <div>
 <div className=" font-sans pl-16 pr-16 pt-10 xl:pt-20 lg:pt-20 flex flex-col">
 ...
 <Image
     ...
     <div className="flex flex-col pb-0 md:pb-18 lg:pb-0 xl:pb-0 items-center xl:pt-10 lg:pt-10 pt-40 mx-auto text-center justify-center">
      ...
      <p className="text-white text-xl absolute pt-85 xl:pt-105 lg:pt-105 md:pt-60">10 . 12 . 25</p>
       ...
       <div className="flex  flex-col mx-auto text-center items-center gap-0 pt-8 justify-center">
        <p className="text-white text-md absolute pt-100 xl:pt-130 lg:pt-120 md:pt-80 ">Kepada Yth;</p>
         <p className="text-white text-md absolute pt-110 xl:pt-140 lg:pt-130 md:pt-90 ">Bapak/Ibu/Saudra/i</p>
     </div>

     
     <div className="flex justify-center pt-70 xl:pt-85 lg:pt-85 md:pt-60 pl-3  items-center">
